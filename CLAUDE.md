...
| Council meeting agendas/minutes | `ipswich.infocouncil.biz/Open/YYYY/MM/{COMMITTEE}_YYYYMMDD_{AGN|MIN}_XXXX_AT.htm` | Not yet built. Static per-meeting HTML; attachments are PDFs in a parallel `_files/` folder. |
